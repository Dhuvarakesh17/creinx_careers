...
import styles from "@/components/target-cursor.module.css";
...
export default function TargetCursor({
  ...
  useEffect(() => {
    ...
    cornersRef.current = cursor.querySelectorAll<HTMLDivElement>("[data-corner='true']");
        ...
        if (cornersRef.current) {
          ...
          cornerList.forEach((corner, index) => {
            tl.to(
              corner,
              {
                x: homePositions[index].x,
                y: homePositions[index].y,
                duration: 0.3,
                ease: "power3.out",
              },
              0,
  ...
  return (
    <div ref={cursorRef} className={styles.wrapper}>
      ...
      <div data-corner="true" className={`${styles.corner} ${styles.cornerTl}`} />
      <div data-corner="true" className={`${styles.corner} ${styles.cornerTr}`} />
      <div data-corner="true" className={`${styles.corner} ${styles.cornerBr}`} />
      <div data-corner="true" className={`${styles.corner} ${styles.cornerBl}`} />
    </div>
  );
}
